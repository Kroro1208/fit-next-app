...
CREATE TABLE "Post" (
    ...
    "shareLinkVisible" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_subName_fkey" FOREIGN KEY ("subName") REFERENCES "Community"("name") ON DELETE SET NULL ON UPDATE CASCADE;
